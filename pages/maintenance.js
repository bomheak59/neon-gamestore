...
export default function Maintenance() {
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4 text-center relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-linear-to-b from-black via-transparent to-black opacity-80"></div>

      <div className="relative z-10 max-w-lg animate-pulse-slow">
        ...
        <h1 className="text-4xl md:text-6xl font-black tracking-tighter mb-4 text-transparent bg-clip-text bg-linear-to-r from-red-500 to-orange-500">
          SYSTEM OFFLINE
        </h1>
