  ...
  return (
    <div className="min-h-screen  text-white overflow-x-hidden font-sans selection:bg-cyan-500/50 relative">
      ...
      <style jsx>{`
        ...
        /* 🔥 Scanlines (เส้นทีวี) - ปรับให้ชัดขึ้น 🔥 */
        .scanlines {
            background: linear-gradient(
                to bottom,
                rgba(255,255,255,0),
                rgba(255,255,255,0) 50%,
                rgba(0,0,0,0.2) 50%, /* เพิ่มความเข้มเงา */
                rgba(0,0,0,0.2)
            );
            background-size: 100% 4px; /* ขนาดเส้น */
            position: absolute;
            top: 0; left: 0; right: 0; bottom: 0;
            pointer-events: none; /* ให้คลิกทะลุได้ */
            z-index: 10; /* อยู่บนสุด */
            mix-blend-mode: overlay; /* ผสมกับสีพื้นหลังให้ดูเนียน */
        }

        /* อนิเมชั่นเลื่อน Grid */
